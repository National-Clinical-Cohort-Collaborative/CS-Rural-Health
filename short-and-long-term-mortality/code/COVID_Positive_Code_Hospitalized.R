...
# -------------------------------------------------------------------------
# Step 0: Filter to patients with documented SARS-CoV-2 infection and
# those hospitalized after infection.
# -------------------------------------------------------------------------
...
# -------------------------------------------------------------------------
# Step 4: Age Standardized Death Risk and Rates
...
# -------------------------------------------------------------------------
# Step 5: Generate Univariable and Multivariable Cox Models 
...
# -------------------------------------------------------------------------
# Step 6: Estimate Stabilized IPT Weights for Multinomial Rurality Variable
# -------------------------------------------------------------------------
...
# ----------------------------
# Step 6b: Summary Statistics of Stabilized Weights
# ----------------------------
...
# ------------------------------------------
# Step 6c: Propensity Score Diagnostics (Predictions)
# ------------------------------------------
...
# -------------------------------------------------------------------------
# Step 7: Run Weighted Multilevel Cox Models at Multiple Time Horizons
