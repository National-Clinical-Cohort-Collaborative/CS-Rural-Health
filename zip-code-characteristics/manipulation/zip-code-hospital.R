# knitr::stitch_rmd(script="manipulation/zip-code-hospital.R", output="stitched-output/manipulation/zip-code-hospital.md") # dir.create("stitched-output/manipulation/", recursive=T)
...
# figure_path <- 'stitched-output/manipulation/zip-code-hospital/'
...
# Pivot to one row per zip, and join with two other zip-grain datasets.
ds_wide <-
